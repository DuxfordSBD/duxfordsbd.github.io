...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000" class="icon-tree"> Duxford Soapbox Derby</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/about/">About The Derby</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/about/with-thanks-to">With Thanks To</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/particpating/rules">Taking Part</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/particpating/rules">General Rules</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/particpating/adult-rules">Adult Race</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/particpating/childrens-rules/">Children&#39;s Race</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/participating/route-map">Route Map</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/particpating/terms-and-conditions/">Terms and Conditions</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/particpating/event-disclaimer">Event Disclaimer</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/results/2018-results">Derby Results</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/results/2018-results">2018 Soapbox Derby Results</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/results/2017-results">2017 Soapbox Derby Results</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/results/2016-results">2016 Soapbox Derby Results</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/gallery/2018-photos">Gallery</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/gallery/2018-photos">2018-photos</a></li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/" title="Duxford Soapbox Derby – News, Photos, videos and more!">
				<img src="http://localhost:4000/assets/img/Duxford-SBD-logo-header.png" alt="Duxford Soapbox Derby – News, Photos, videos and more!">
			</a>
